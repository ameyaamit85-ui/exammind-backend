export default async function handler(req, res) {
    ...
    try {
        ...
        if (!isFollowUp) {
            ...
            1. "answer": strictly max 2 to 5 words! ONLY the final numerical value or core concept name.
            2. "desc": Detailed 3-4 sentence explanation.
            3. "trap": Explain the common student mistake deeply.
            4. "formula": The core mathematical equation used. (If pure theory, write "Conceptual").
            5. DO NOT USE LaTeX. Use plain text (e.g., 1/r^2).
            6. Output strictly in JSON format. If a field is not applicable, output "" or [].
            Keys MUST BE EXACTLY: hidden_scratchpad, formula, answer, confidence, is_match, desc, trap, steps.`;
        } else {
